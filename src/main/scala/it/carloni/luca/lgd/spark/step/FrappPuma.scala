...
class FrappPuma(private val dataA: String)
  ...
  override def run(): Unit = {
    ...
    val dataFineDefSubtractDurationCol = subtractDurationUDF(toStringType(cicliNdgPrinc("datainiziodef")), LGDCommons.DatePatterns.Y4M2D2Pattern, 1)
    val leastDateSubtractDurationCol = leastDateUDF(dataFineDefSubtractDurationCol, dataAFormatted, LGDCommons.DatePatterns.Y4M2D2Pattern)
